...
void Vec2::RotateBy(float angle)
{
...
void Vec2::RotateBy(float cosAngle, float sinAngle)
{
...
{
	projectee.Normalise();
	return projectee * Dot(projector, projectee);
}
